...
export default function ChatLoading() {
  return (
    <main className="flex h-[100dvh] min-h-[100svh] overflow-hidden bg-black text-white">
      ...
      <section className="relative flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="relative z-10 min-h-0 flex-1 overflow-hidden px-4 py-6 sm:px-6">
