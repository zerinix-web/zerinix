...
// reported "TAM: $1." PDF truncation. `[^.\n]*` stopped at the FIRST
// period found, with no concept of a decimal point -- for "TAM: $1.5B is
// the total addressable market...", the decimal point in "$1.5B" itself
// was mistaken for the sentence's own terminating period, cutting the
// match down to "TAM: $1." before this function's own caller (the
// TAM/SAM/SOM circle-legend's assumption line) ever drew anything.
...
// page.tsx/Planner.tsx. Declared locally (not at module scope) so the
// function stays self-contained if ever isolated.
