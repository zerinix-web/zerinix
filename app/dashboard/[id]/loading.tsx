export default function ReportLoading() {
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden bg-black text-white lg:min-h-screen lg:overflow-hidden">
      ...
      <div className="flex min-h-[100dvh] flex-col lg:min-h-screen lg:flex-row">
        ...
        <section className="relative z-10 flex-1 px-4 pt-5 pb-[calc(10rem+env(safe-area-inset-bottom))] sm:px-8 lg:px-10 lg:py-8">
          <div className="rounded-[2rem] border border-white/[0.12] bg-white/[0.045] p-5 shadow-2xl shadow-black/35 ring-1 ring-white/[0.03] backdrop-blur-xl sm:rounded-[2.15rem] sm:p-6">
          ...
          <div className="mt-5 grid gap-4 lg:mt-6 lg:grid-cols-[18rem_minmax(0,1fr)] lg:gap-6">
            ...
            <div className="space-y-4 lg:space-y-6">
              {Array.from({ length: 4 }).map((_, index) => (
                <div
                  ...
                  className="rounded-[1.55rem] border border-white/[0.12] bg-white/[0.045] p-4 shadow-2xl shadow-black/25 ring-1 ring-white/[0.03] sm:rounded-[1.85rem] sm:p-6"
                >
