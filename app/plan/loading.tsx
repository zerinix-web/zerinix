...
export default function PlanLoading() {
  return (
    <main className="flex h-[100dvh] min-h-[100svh] flex-col overflow-hidden bg-black text-white md:flex-row">
      <aside className="flex border-b border-white/10 bg-black/85 p-4 shadow-2xl shadow-black/30 backdrop-blur-2xl md:h-[100dvh] md:w-[21.5rem] md:flex-col md:border-b-0 md:border-r">
      ...
      <section className="relative flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="relative z-10 min-h-0 flex-1 overflow-hidden px-4 py-5 sm:px-5 lg:px-8">
