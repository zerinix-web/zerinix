  ...
  if (profile.domain === "real_estate") {
    return {
      ...
      sections: [
        ...
        section("comparables", "Comparable Market Evidence", "Evaluate genuinely comparable, dated market evidence and its limitations.", "comparable_evidence_review", "critical", ["external_source", "calculation"]),
        section("liquidity", "Liquidity", "Assess buyer depth and saleability only from supported market evidence.", "liquidity_review", "high"),
        section("valuation_inputs", "Valuation Inputs", "State whether valuation gates are met and show only defensible inputs and methods.", "valuation_gate_review", "critical", ["official_source", "external_source", "calculation"]),
