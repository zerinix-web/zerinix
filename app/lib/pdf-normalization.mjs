...
const pdfPresentationLabelPairs = [
    ...
    ["Validation-Based", "Doğrulamaya Dayalı"],
    ...
    ["Main Risk", "Ana Risk"],
    ["Biggest Opportunity", "Başlıca Fırsat"],
    ["Biggest Risk", "Başlıca Risk"],
    ["Biggest Risks", "Başlıca Riskler"],
    ["Top Risk", "En Önemli Risk"],
    ["Top Risks", "En Önemli Riskler"],
    ["Missing Information", "Eksik Bilgiler"],
    ["Missing Evidence", "Eksik Kanıtlar"],
    ["Information Required Before Decision", "Karardan Önce Gereken Bilgiler"],
    ["What Would Change This Decision", "Bu Kararı Ne Değiştirir"],
    ["Immediate Next Action", "Acil Sonraki Adım"],
    ["First 90-Day Action Plan", "İlk 90 Günlük Aksiyon Planı"],
