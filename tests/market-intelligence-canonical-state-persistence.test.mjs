...
test("I3. a real (non-legacy) version number matches the module's own exported constant", () => {
  ...
  // immediateNextAction added). TASK #33 -- bumped again, 2 -> 3
  // (marketSizing.evidenceIds + the new top-level cagr array, source-
  // provenance audit); zero real data affected either time, see
